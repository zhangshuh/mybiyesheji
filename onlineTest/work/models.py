...
class HomeWork(models.Model):
    ...
    tiankong_ids = models.CharField(max_length=200, verbose_name='程序填空题id列表')
    gaicuo_ids = models.CharField(max_length=200, verbose_name='程序改错题id列表')
    problem_info = models.TextField()
    choice_problem_info = models.TextField()
    tiankong_problem_info = models.TextField();
    gaicuo_problem_info = models.TextField();
...
class MyHomework(models.Model):
    ...
    tiankong_problem_ids = models.CharField(max_length=200, verbose_name='程序填空题id列表', null=True, blank=True)
    gaicuo_ids = models.CharField(max_length=200, verbose_name='程序改错题id列表', null=True, blank=True)
...
class HomeworkAnswer(models.Model):
    ...
    tiankong_score = models.IntegerField(null=True, verbose_name='程序填空题成绩')
    gaicuo_score = models.IntegerField(null=True, verbose_name='程序改错题成绩')
