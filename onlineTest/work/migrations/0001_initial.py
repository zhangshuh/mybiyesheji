    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiankong_problem_ids', models.CharField(blank=True, max_length=200, null=True, verbose_name='程序填空题id列表')),
                ('gaicuo_ids', models.CharField(blank=True, max_length=200, null=True, verbose_name='程序改错题id列表')),
                ...
                ('courser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.ClassName', verbose_name='所属课程')),
                ('creater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('finished_students', models.ManyToManyField(blank=True, null=True, related_name='finished_students', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
